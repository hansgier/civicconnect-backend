...
export async function seed() {
  ...
  await prisma.barangay.createMany({
    data: barangayNames.map((name, i) => ({
      name,
      district: i < 29 ? 'District 1' : 'District 2',
    })),
    skipDuplicates: true,
  });
  ...
  const projectData = [
    {
      title: 'Poblacion Drainage Repair',
      status: 'COMPLETED',
      brgy: 'Barangay 1 (Pob.)',
      fund: 0,
    ...
    {
      title: 'Valencia Multi-Purpose Hall',
      status: 'ONGOING',
      brgy: 'Valencia',
      fund: 4,
      category: 'SOCIAL',
    ...
    {
      title: 'Cogon Elementary School Building',
      status: 'ONGOING',
      brgy: 'Cogon',
      fund: 1,
      category: 'EDUCATION',
    ...
    {
      title: 'Ipil Health Center Renovation',
      status: 'PLANNED',
      brgy: 'Ipil',
      fund: 0,
      category: 'HEALTH',
    ...
    {
      title: 'Tongonan Water System Expansion',
      status: 'PLANNED',
      brgy: 'Tongonan',
      fund: 2,
      category: 'WATER',
      ...
      data: [
        {
          ...
          description: 'Equipment and materials delivered to site.',
          projectId: project.id,
          date: new Date('2024-10-01'),
        },
        {
          title: 'Phase 1 Completion',
          description: 'Initial structural work completed.',
          projectId: project.id,
  ...
  await prisma.contact.createMany({
    data: [
      {
        title: 'Engr. Maria Santos',
        description: 'Lead Engineer',
        phoneNumbers: ['0917-111-2222'],
        type: 'GOVERNMENT',
        createdById: admin.id,
      },
      {
        title: 'Atty. Jose Rizal',
        description: 'City Legal Officer',
        phoneNumbers: ['0917-333-4444'],
        type: 'GOVERNMENT',
        createdById: admin.id,
      },
      {
        title: 'Dr. Linda Gomez',
        description: 'Health Officer',
        phoneNumbers: ['0917-555-6666'],
        type: 'HEALTH',
        createdById: admin.id,
      },
    ],
  ...
  await prisma.notification.create({
    data: {
      ...
      description:
        'Thank you for registering. You can now track infrastructure projects in your barangay.',
      type: 'SYSTEM',
      userId: citizen.id,
    },
  });
